  ...
  const handleToggleStatus = async (planId: number, currentStatus: boolean) => {
    try {
      ...
      if (response.success) {
        toast.success(
          currentStatus
            ? t("subscriptionPlans.planDeactivated")
            : t("subscriptionPlans.planActivated")
        );
        loadPlans();
      }
    } catch (error) {
            ...
            <DialogContent className="max-w-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label htmlFor="durationDays">
                      {t("subscriptionPlans.durationDays")}
                    </Label>
                    <Input
                      id="durationDays"
                      type="number"
                      ...
                      placeholder={t(
                        "subscriptionPlans.durationDaysPlaceholder"
                      )}
                      required
                    />
                  </div>
                ...
                <div className="flex justify-end gap-2">
                  ...
                  <Button type="submit">
                    {editingPlan
                      ? t("subscriptionPlans.updatePlan")
                      : t("subscriptionPlans.createPlanButton")}
                  </Button>
                </div>
              </form>
            </DialogContent>
            ...
            <CardContent>
              {loading ? (
                <div className="text-center py-8">
                  {t("subscriptionPlans.loadingPlans")}
                </div>
              ) : (
                                  ...
                                  <AlertDialogContent>
                                    <AlertDialogHeader>
                                      ...
                                      <AlertDialogDescription>
                                        ...
                                        {plan.name}"? This action cannot be
                                        undone.
                                      </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
